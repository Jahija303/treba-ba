        ...
        <template #mainContent>
            ...
            <jet-dialog-modal :show="createPermissionModal" @close="closeModal">
                ...
                <template #footer>
                    ...
                    <jet-secondary-button class="ml-2" @click="createPermission" :class="{ 'opacity-25': form.processing }" :disabled="form.processing">
                        Create permission
                    </jet-secondary-button>
                </template>
            </jet-dialog-modal>
            ...
            <jet-dialog-modal :show="editPermissionModal" @close="closeModal">
                ...
                <template #footer>
                    ...
                    <jet-secondary-button class="ml-2" @click="updatePermission" :class="{ 'opacity-25': form.processing }" :disabled="form.processing">
                        Update permission
                    </jet-secondary-button>
                </template>
            </jet-dialog-modal>
